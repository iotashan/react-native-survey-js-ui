...
describe('Library Packaging Tests', () => {
  ...
  describe('Build Output Validation', () => {
    ...
    test('CommonJS build contains required files', () => {
      ...
      expect(fs.existsSync(path.join(commonjsDir, 'components', 'Survey', 'Survey.js'))).toBe(true);
      expect(fs.existsSync(path.join(commonjsDir, 'components', 'Questions', 'index.js'))).toBe(true);
      
      // Hooks directory
      expect(fs.existsSync(path.join(commonjsDir, 'hooks', 'index.js'))).toBe(true);
      
      // Utils directory
      expect(fs.existsSync(path.join(commonjsDir, 'utils', 'index.js'))).toBe(true);
      
      // Types directory
      expect(fs.existsSync(path.join(commonjsDir, 'types', 'index.js'))).toBe(true);
    ...
    test('ES Module build contains required files', () => {
      ...
      // Component directories
      expect(fs.existsSync(path.join(moduleDir, 'components', 'Survey', 'Survey.js'))).toBe(true);
      expect(fs.existsSync(path.join(moduleDir, 'components', 'Questions', 'index.js'))).toBe(true);
      
      // Hooks directory
      expect(fs.existsSync(path.join(moduleDir, 'hooks', 'index.js'))).toBe(true);
      
      // Utils directory
      expect(fs.existsSync(path.join(moduleDir, 'utils', 'index.js'))).toBe(true);
      
      // Types directory
      expect(fs.existsSync(path.join(moduleDir, 'types', 'index.js'))).toBe(true);
    ...
    test('TypeScript declarations are generated correctly', () => {
      ...
      expect(fs.existsSync(path.join(moduleDeclarations, 'index.d.ts'))).toBe(true);
      expect(fs.existsSync(path.join(commonjsDeclarations, 'index.d.ts'))).toBe(true);
      
      // Component declarations
      expect(fs.existsSync(path.join(moduleDeclarations, 'components', 'Survey', 'Survey.d.ts'))).toBe(true);
      expect(fs.existsSync(path.join(moduleDeclarations, 'components', 'Questions', 'index.d.ts'))).toBe(true);
      
      // Hook declarations
      expect(fs.existsSync(path.join(moduleDeclarations, 'hooks', 'index.d.ts'))).toBe(true);
      
      // Type declarations
      expect(fs.existsSync(path.join(moduleDeclarations, 'types', 'index.d.ts'))).toBe(true);
      expect(fs.existsSync(path.join(moduleDeclarations, 'types', 'SurveyTypes.d.ts'))).toBe(true);
    });
    ...
    test('Test files are excluded from build output', () => {
      ...
      expect(fs.existsSync(path.join(commonjsDir, 'components', 'Survey', 'Survey.test.js'))).toBe(false);
      expect(fs.existsSync(path.join(moduleDir, 'components', 'Survey', 'Survey.test.js'))).toBe(false);
  ...
  describe('Package.json Configuration', () => {
    ...
    test('Package exports are properly configured', () => {
      ...
      expect(mainExport.import.types).toBe('./lib/typescript/module/index.d.ts');
      expect(mainExport.import.default).toBe('./lib/module/index.js');
      
      // Require configuration
      expect(mainExport.require.types).toBe('./lib/typescript/commonjs/index.d.ts');
  ...
  describe('Main Export File Validation', () => {
    ...
    test('TypeScript declaration file is valid', () => {
      const declarationFile = path.join(libDir, 'typescript', 'module', 'index.d.ts');
